        ...
        child: Column(
          children: [
                  ...
                  children: [
                    Container(
                      ...
                      decoration: const BoxDecoration(
                          ...
                          boxShadow: [BoxShadow(color: Color(0xfffef10e), blurRadius: 100)]),
                    ),
                    const Text("Updating", style: TextStyle(color: Colors.white, fontSize: 20)),
                  ],
                ),
              ),
            ),
            Container(
              ...
              decoration: const BoxDecoration(
                  shape: BoxShape.circle, boxShadow: [BoxShadow(color: Color(0xff45433d), blurRadius: 100)]),
              child: Image.asset("assets/thundercloud.png"),
            ),
            const Text("23*", style: TextStyle(fontSize: 50, color: Colors.white, fontWeight: FontWeight.bold)),
            const Text("Thunderclouds", style: TextStyle(color: Colors.grey, fontSize: 30)),
            Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Text(todayWeather[index].time,
                              style: TextStyle(color: index == 1 ? Colors.white : Colors.grey, fontSize: 16)),
                        ],
                      ),
                    );
                  },
